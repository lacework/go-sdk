...
func TestQueryCreateEditorWithLanguage(t *testing.T) {
	out, err, exitcode := LaceworkCLIWithTOMLConfig("query", "create", "--language", "LQL")
...
func TestQueryCreateEditorWithoutLanguage(t *testing.T) {
