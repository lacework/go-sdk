...
func (c *coreClient) ReadCache(ctx context.Context, in *ReadCacheRequest, opts ...grpc.CallOption) (*ReadCacheResponse, error) {
	out := new(ReadCacheResponse)
	err := c.cc.Invoke(ctx, "/cdk.v1.Core/ReadCache", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) WriteCache(ctx context.Context, in *WriteCacheRequest, opts ...grpc.CallOption) (*WriteCacheResult, error) {
	out := new(WriteCacheResult)
	err := c.cc.Invoke(ctx, "/cdk.v1.Core/WriteCache", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCoreServer) WriteCache(context.Context, *WriteCacheRequest) (*WriteCacheResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WriteCache not implemented")
}
...
func _Core_ReadCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadCacheRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ReadCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cdk.v1.Core/ReadCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ReadCache(ctx, req.(*ReadCacheRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Core_WriteCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteCacheRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).WriteCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cdk.v1.Core/WriteCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).WriteCache(ctx, req.(*WriteCacheRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Core_ReadCache_Handler,
		},
		{
			MethodName: "WriteCache",
			Handler:    _Core_WriteCache_Handler,
		},
	},
